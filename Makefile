...
# Template: app
# Command: C:\Qt\6.2.4\mingw_64\bin\qmake.exe -o Makefile clientserver.pro -spec win32-g++ "CONFIG+=qml_debug"
#############################################################################
...
Makefile: clientserver.pro ../../../../Qt/6.2.4/mingw_64/mkspecs/win32-g++/qmake.conf ../../../../Qt/6.2.4/mingw_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile clientserver.pro -spec win32-g++ "CONFIG+=qml_debug"
